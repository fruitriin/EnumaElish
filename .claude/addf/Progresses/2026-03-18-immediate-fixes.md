...
## タスク: Plan 0001 — 即時修正（typo・不整合・欠落ファイル）

- [x] 1. `CLAUDE.repo.example.md` の typo 修正（「起かない」→「置かない」）
- [x] 2. `CLAUDE.local.example.md` の作成
- [x] 3. `.claude/addf/knowhow/INDEX.md` の初期生成
- [x] 4. `plan.md` の削除
- [x] 5. `.gitignore` に `node_modules` 追加
- [x] 6. `.claudeignore` にバイナリ追加
- [x] 7. TODO.md の状態を「実施中」に更新
- [x] 8. 品質検証（コードレビュー + コントリビューション検出）
- [x] 9. 完了処理
