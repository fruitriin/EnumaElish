...
| 🟢 2026-07-17 | [plan-0022-0025-lessons.md](plan-0022-0025-lessons.md) | Plan 0022（ask_strategy/approve/sentinel）と Plan 0025（for ループ展開）の実装＋ペルソナ並列レビューで得た 15 パターン: hook 出力の新旧共存、canonical hash に argSep、Result フィールド伝播、AST default 分岐の危険、bodyRedefinesVar とビルトイン、for の word splitting 乖離、`\rm` エスケープ、conf 自己書換保護、ステイルロック、env-var seam、UI サニタイズ、hint にトークン非掲載、委譲プロンプトの前提 grep、兄弟課題の AST 層束ね、ペルソナ並列 4 体運用 | Plan 0022, Plan 0025, hook exit 2, permissionDecision, canonical hash, argv boundary, Unattended, Unit Separator, ForClause, bodyRedefinesVar, ビルトイン, 空白リテラル, wordToString, \rm, .ccchain.conf 保護, ステイルロック, O_EXCL, SetDefaultDirForTest, ANSI サニタイズ, ペルソナ並列, skeptic, attacker, security, worktree base 経過差 |
