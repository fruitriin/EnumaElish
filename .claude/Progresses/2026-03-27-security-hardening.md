...
## タスク: Plan 0005 — セキュリティ強化

### Critical
- [x] VULN-01: 制御構造（for/if/while/case/group/func）を Analyzable: false に
- [x] VULN-02: matchesRule で filepath.Base による照合追加

### High
- [x] VULN-03: parseFindExec で全 -exec を収集
- [x] VULN-04: parseXargs のフラグ完全リスト化 + --flag=value 対応
- [x] VULN-05: env/sudo/doas のネスト検査追加

### テスト・検証
- [x] 各 VULN のバイパス回帰テスト（16テスト追加）
- [x] `go test ./...` + `go vet ./...` 通過
