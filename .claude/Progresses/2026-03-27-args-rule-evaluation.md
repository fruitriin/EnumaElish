...
## タスク: Plan 0008 — args: ルール評価の実装

### Phase 1: ArgsRule 事前コンパイル
- [ ] ArgsRule に Compiled フィールド追加
- [ ] ResolveTemplates/ValidateConfig で全パターンをコンパイル

### Phase 2: 評価エンジンへの組み込み
- [ ] applyArgsRules 共通関数
- [ ] matchCommand に組み込み
- [ ] containsDynamicArgs で動的引数チェック

### Phase 3: パイプ/exec コンテキスト対応
- [ ] matchInPipeContext / matchInExecContext に適用

### Phase 4: テスト
- [ ] 基本マッチ、結合形式、動的引数、パイプコンテキスト
- [ ] セキュリティバイパステスト

### Phase 5: ドキュメント更新
- [ ] DSL リファレンスの args: 未実装注記を削除
